  ...
  render: function(){
    return(
      React.createElement("div", null, 
        React.createElement(SearchForm, {onFormSubmit: this.handleFormSubmit}), 
        this.state.username ? React.createElement(UserInfo, {userData: this.state.userData}) : null, 
        this.state.username ? React.createElement(Repos, {repoData: this.state.repoData}) : null
      )
      )
  }
  });
...
},{"./repos":160,"./searchForm":161,"./userInfo":162,"react":157}],159:[function(require,module,exports){
var React = require('react');

var Repo = React.createClass({displayName: "Repo",
  render: function(){
    return(
      React.createElement("div", {className: "repo-item"}, 
        React.createElement("h4", null, 
          React.createElement("a", {target: "_blank", href: this.props.url}, 
            this.props.name
          )
        ), 
...
var Repos = React.createClass({displayName: "Repos",
  render: function(){
    var repoNodes = this.props.repoData.map(function(repo, index){
        return(
          React.createElement(Repo, {name: repo.name, description: repo.description, url: repo.html_url, key: index})
          )
    });
    return(
      React.createElement("div", null, 
        React.createElement("h2", {className: "page-header"}, "Latest Repos"), 
        repoNodes
      )
      )
  }
...
},{"./repo":159,"react":157}],161:[function(require,module,exports){
var React = require('react');
...
var SearchForm = React.createClass({displayName: "SearchForm",
  ...
  render: function(){
    return(
      React.createElement("form", {onSubmit: this.submitForm, className: "form-inline"}, 
        React.createElement("div", {className: "form-group"}, 
          React.createElement("input", {type: "text", onChange: this.usernameInput, className: "form-control searchInput", placeholder: "Enter Github username", value: this.state.username})
        ), 
      ...
      React.createElement("div", null, 
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-md-4"}, 
            React.createElement("img", {className: "thumbnail", style: {width:'100%'}, src: this.props.userData.avatar_url})
          ), 
          React.createElement("div", {className: "col-md-8"}, 
            React.createElement("h3", null, this.props.userData.name), 
            React.createElement("a", {className: "btn btn-primary", target: "_blank", href: this.props.userData.html_url}, "Github Page")
          )
        ), 

        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-md-12"}, 
            React.createElement("span", {className: "label label-primary"}, this.props.userData.public_repos, " Repos"), 
            React.createElement("span", {className: "label label-success"}, this.props.userData.public_gists, " Gists"), 
            React.createElement("span", {className: "label label-info"}, this.props.userData.followers, " Followers"), 
            React.createElement("span", {className: "label label-danger"}, this.props.userData.following, " Following")
          )
        ), 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement("div", {className: "col-md-12"}, 
            React.createElement("ul", {className: "list-group"}, 
              ...
              React.createElement("strong", null, "Username:"), " ", this.props.userData.login
              ), 
              React.createElement("li", {className: "list-group-item"}, 
              React.createElement("strong", null, "Location:"), " ", this.props.userData.location
              ), 
              React.createElement("li", {className: "list-group-item"}, 
              React.createElement("strong", null, "Email:"), " ", this.props.userData.email
              )
            )
          )
        )
...
var Main = React.createClass({displayName: "Main",
  render: function(){ return (React.createElement(Profile, null)); }
});

React.render(React.createElement(Main, null), document.getElementById('main'));

},{"./components/profile":158,"jquery":2,"react":157}]},{},[163]);
